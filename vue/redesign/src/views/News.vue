        ...
        <div class="update-contaniner">
          ...
          <section class="change-log-text-container">
            <p class="change-log-message txt">
              ...
              get-up, I don’t actually know how much I’ll use the deck itself.
              As the Horde offensive progresses, Alliance casualties will be
              sent back to progressively higher levels – first E/W, then South,
              then the Courtyard. At some point, one of these ‘expert analysts’
            ...
            <p class="change-log-message txt">
              ...
              I knew almost nothing about my class, while questing. I’ve
              previously talked about the true dynamic nature of WH space in
              EVE, and I want to use last weekends Op as a backdrop to sum that
              thought up and perhaps add some clarity to it as well. Then
              there’s the hitching, stuttering, and framerate issues he
          ...
          <div class="right-column-container">
            <div class="feature-text-container">
              ...
              <p class="feature-text txt">
                ...
                almost nothing about my class, while questing. I’ve previously
                talked about the true dynamic nature of WH space in EVE, and I
                want to use last weekends Op as a backdrop to sum that thought
                up and perhaps add some clarity to it as well. Then there’s the
                hitching, stuttering, and framerate issues he experiences that
